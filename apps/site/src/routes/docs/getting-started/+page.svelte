...
<div class="docs-layout">
  <aside class="sidebar">
    <nav class="sidebar-nav">
      ...
      <a href="#step-1" class="sidebar-link">1. Create account</a>
      <a href="#step-2" class="sidebar-link">2. Register a server</a>
      <a href="#step-3" class="sidebar-link">3. Install Crucible</a>
      <a href="#step-4" class="sidebar-link">4. Verify</a>
      <a href="#keys" class="sidebar-link">Two kinds of keys</a>
